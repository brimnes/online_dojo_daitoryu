  ...
  if (!accessLoading && !canAccess) {
    return (
      <div style={{ padding: '60px 32px', textAlign: 'center', background: '#faf8f4', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 16 }}>
        ...
        <div style={{ fontFamily: "var(--font-cormorant-sc), var(--font-cormorant), 'Cormorant Garamond', serif", fontSize: 20, color: '#9e2f1f' }}>Нет доступа к разделу</div>
    ...
    <div className="fade" style={{ padding: '32px 36px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 20, marginBottom: 24, paddingBottom: 20, borderBottom: `2px solid ${C.border}` }}>
        <div style={{ flex: 1 }}>
          ...
          <h1 style={{ fontFamily: "var(--font-cormorant-sc), var(--font-cormorant), 'Cormorant Garamond', serif", fontSize: 28, color: '#9e2f1f', marginBottom: 4 }}>{tech.nameRu}</h1>
